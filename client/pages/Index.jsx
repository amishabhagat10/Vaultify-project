      ...
      <div className="relative z-10">
        ...
        <header className="flex justify-between items-center px-8 py-6 relative z-20">
          <div className="flex items-center">
            <h1 className="text-white text-[32px] font-bold font-inter">Vaultify</h1>
          </div>
          
          <nav className="flex items-center space-x-8">
            <a href="#features" className="text-white text-[18px] font-inter hover:text-vaultify-purple transition-colors">Features</a>
            <a href="#what-we-offer" className="text-white text-[18px] font-inter hover:text-vaultify-purple transition-colors">What We Offer</a>
            <a href="#faq" className="text-white text-[18px] font-inter hover:text-vaultify-purple transition-colors">FAQ's</a>
            <a href="#about" className="text-white text-[18px] font-inter hover:text-vaultify-purple transition-colors">About Us</a>
          </nav>
          
          <Link to="/login" className="vaultify-btn-secondary">
            Connect Wallet
          </Link>
        </header>

        {/* Hero Section */}
        <section className="text-center py-20 px-8 relative z-20">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-white text-[55px] font-bold font-inter leading-tight mb-4">
              Your Digital Vault
            </h1>
            <h2 className="text-vaultify-text-gray text-[45px] font-bold font-inter leading-tight mb-12">
              Secure on the Blockchain
            </h2>
            <button className="vaultify-btn-primary text-[22px]">
              Connect Wallet
            </button>
          </div>
        </section>
        ...
        {/* FAQ Section */}
        <section id="faq" className="py-20 px-8 relative z-20">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-white text-[41px] font-bold font-inter mb-4">FAQs</h2>
              <p className="text-vaultify-text-gray text-[41px] font-bold font-inter">
              ...
              {[
                {
                  ...
                  answer: "No. We only store the cryptographic hash of your document on-chain. The actual file remains encrypted and can be deleted at your discretion."
                },
                {
                  question: "Do I need a crypto wallet to use Vaultify?",
                  answer: "Yes, you need a crypto wallet to authenticate and interact with the blockchain features of Vaultify."
                },
                {
                  question: "What if I lose my encryption key?",
                  answer: "If you lose your encryption key, the data cannot be recovered. We recommend storing your keys securely and having backup procedures in place."
                },
                {
                  question: "Can I revoke a document I shared?",
                  answer: "Yes, you can revoke access to shared documents at any time through your Vaultify dashboard."
                },
                {
                  question: "Can I prove ownership of a document later?",
                  answer: "Yes, the blockchain record provides immutable proof of when you uploaded and owned the document."
                }
              ].map((faq, index) => (
        ...
        <section className="py-20 px-8 relative z-20">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-white text-[41px] font-bold font-inter mb-4">
              Start Your Vault
            </h2>
            <p className="text-vaultify-text-gray text-[27px] font-bold font-inter mb-8">
              Store, verify, and share with blockchain-level security.
            </p>
            <button className="bg-purple-gradient-alt text-white text-[18px] font-bold font-inter px-8 py-3 rounded-[18px] hover:transform hover:scale-105 transition-all duration-300">
              Create Your Account
            </button>
          </div>
        </section>
        ...
        {/* Large Brand Text */}
        <div className="absolute bottom-0 left-0 right-0 text-center py-20 z-10">
          <h1 className="vaultify-title-gradient font-impact text-[344px] font-normal leading-none pointer-events-none select-none">
            VAULTIFY
          </h1>
        </div>
      </div>

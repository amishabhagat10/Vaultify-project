      ...
      <div className="relative z-10">
        ...
        <header className="flex justify-between items-center px-8 py-6 relative z-20">
          <div className="flex items-center">
            <h1 className="text-white text-[32px] font-bold font-inter">
              Vaultify
            </h1>
          </div>
        ...
        <footer className="py-16 px-8 relative z-20">
          <div className="max-w-6xl mx-auto">
            <div className="flex justify-center items-center space-x-8 mb-8">
              <a
                href="#"
                className="text-vaultify-text-light-gray text-[14px] font-bold font-inter hover:text-white transition-colors"
              >
                About
              </a>
              <a
            ...
            <div className="flex justify-center items-center space-x-8 mb-8">
              <a
                href="#"
                className="text-vaultify-text-light-gray text-[11px] font-inter hover:text-white transition-colors"
              >
                Legal Notices
              </a>
              <a
